...
function Navbar() {
  ...
  return (
    <>
      {/* Fixed Navbar */}
      <header className="fixed top-0 left-0 right-0 z-[9999] border-b border-gray-100 bg-white/95 backdrop-blur-md">
        ...
        {/* Mobile Menu */}
        {menuOpen && (
          <div className="border-t border-gray-100 bg-white px-4 pb-5 shadow-md md:hidden">
